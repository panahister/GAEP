...
| Exact input snapshot | 46 semantic input files; deterministic aggregate SHA-256 `34b3adcae06d09216d5d9a4f518289e3e95a86ea135ca09d4c559728b7f3b3a0`, calculated over sorted lines of `<normalized-file-sha256><two spaces><repository-relative-path><newline>`. For the scenario catalog, migration map, and manual rehearsal plan, their respective result sections are omitted before the file digest so the evidence record does not hash itself; every other included file is hashed byte-for-byte. |
