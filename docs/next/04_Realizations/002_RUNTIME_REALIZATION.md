...
| GAEP-RUN-REQ-004 | A runtime SHALL consume the exact Profile Selection Manifest, Effective Policy Snapshot, and effective-configuration manifest and SHALL delegate material-change invalidation and re-evaluation to the rules in GAEP-PCR-REQ-020, GAEP-DRAA-REQ-020, GAEP-DRAA-REQ-021, GAEP-DRAA-REQ-025, GAEP-DRAA-REQ-026, and GAEP-EER-REQ-006 rather than maintaining a competing validity rule. | Mid-run change scenario |
