...
version: 0.1.0
status: proposed
owner_role: Organizational Trust Authority
...
| Authority, evidence, and cadence | Organizational Trust Authority owns the profile; the manifest identifies workforce, accessibility, ethics, data, legal, and decision authorities, affected-person evidence, consultation, review cadence, and appeal ownership. |
