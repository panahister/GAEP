...
| GAEP-EER-OD-006 | GAEP-CORE-011 | Which effect-descriptor combinations require logically separated preparation and commitment? | GAEP-CORE-006/011; effect-commit gate | GAEP Specification Steward | open | Approved Decision Record; effect profile revision; irreversible-effect tests |
