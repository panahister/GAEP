...
| PLT-04 | Visual Studio Native VSIX | Phase 0 / 1A | Native Visual Studio extension installable on Windows | `🟡 In Progress` | `2da531f` adds exact bounded staged review/apply/discard to the compiled out-of-process Remote UI and raises the private-safe hostile protocol/controller harness to 150 checks; Windows container creation, installation and rendered interaction remain |
...
| PLT-24 | Agent and Model Dashboard | Phase 0 / 1A | Provider, model, run status, cost/usage, and handoff evidence | `🟡 In Progress` | Kiro, Rider and Visual Studio now add exact staged inventory, apply/discard availability, transition and not-assessed post-apply outcome truth to their readiness, selection, handoff and bounded Run/evidence projections. Usage, interactive later-page navigation and native acceptance remain incomplete |
...
| PLT-29 | Per-Phase Package and Acceptance Report | Phase 0 / 1A | Package, checksum, test report, and known gaps for every phase | `🟡 In Progress` | `f93376b` records exact current Kiro/Rider/VS Code package hashes plus the 150-check Windows-package limit in `evidence/local-packages/2026-07-24T143846Z-phase-0-local-staged-review-visual-studio.json` and the 53/7/0 matrix in `evidence/ide-conformance/2026-07-24T143944Z-phase-0-local-staged-review-visual-studio.json`, preserving native/supported-platform, packaged-engine, human-acceptance and non-release gaps. Later phase reports remain |
