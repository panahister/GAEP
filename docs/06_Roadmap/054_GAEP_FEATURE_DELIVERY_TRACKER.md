...
| PLT-21 | Dashboard Shell | Phase 0 / 1A | Shared dashboard shell in all four hosts | `🟡 In Progress` | `11452de` and `95d210e` add snapshot-and-total-bound next/previous Managed Run evidence navigation to Rider and Kiro; VS Code and Visual Studio share the bounded inventory/detail truth. Visual Studio later-page navigation, native accessibility/rendering and four-host installation remain incomplete |
...
| PLT-24 | Agent and Model Dashboard | Phase 0 / 1A | Provider, model, run status, cost/usage, and handoff evidence | `🟡 In Progress` | Kiro, Rider and Visual Studio expose exact staged inventory, decisions, readiness, selection, handoff and bounded Run/evidence projections; Kiro and Rider navigate later evidence pages under one exact snapshot. Usage, Visual Studio later-page navigation and native acceptance remain incomplete |
...
| PLT-29 | Per-Phase Package and Acceptance Report | Phase 0 / 1A | Package, checksum, test report, and known gaps for every phase | `🟡 In Progress` | `1ece45f` records the new Rider package and Kiro VSIX digests plus exact current VS Code bytes and the 150-check Windows-package limit in `evidence/local-packages/2026-07-24T145817Z-phase-0-local-evidence-pagination-rider.json`; `evidence/ide-conformance/2026-07-24T145900Z-phase-0-local-evidence-pagination-rider.json` preserves the 53/7/0 matrix and all native/supported-platform, packaged-engine, human-acceptance and non-release gaps. Later phase reports remain |
