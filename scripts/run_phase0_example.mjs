...
function semanticSummary({
  ...
  return {
    ...
    changeImpactSourceBoundary: changeImpactDashboard.sourceBoundary,
    changeImpactEvidenceFreshness: changeImpactDashboard.evidenceCues.freshness,
    changeImpactConfidenceState: changeImpactDashboard.evidenceCues.confidence.state,
    ...
    agentSourceBoundary: agentModelDashboard.sourceBoundary,
    agentEvidenceFreshness: agentModelDashboard.evidenceCues.freshness,
    agentConfidenceState: agentModelDashboard.evidenceCues.confidence.state,
