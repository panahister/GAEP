...
const codexArtifactDirectory = resolve(repository, "evidence/examples/20260731T135700Z-phase-3a-codex-readiness-workflow")
...
function verifyScenario(value) {
  ...
  if (value.parity?.sourceScenarioPath !== "examples/phase-3a-codex-readiness-workflow/scenario.json" ||
      value.parity?.sourceWorkflowReceiptPath !== "evidence/examples/20260731T135700Z-phase-3a-codex-readiness-workflow/receipt.json" ||
