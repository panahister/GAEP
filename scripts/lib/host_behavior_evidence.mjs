...
const definitions = {
  ...
  rider: {
    ...
    packagePlatforms: ["darwin", "linux", "win32"],
    runtimeLevel: "native-startup-and-packaged-engine-client-workflow-local",
    gatePaths: [
    ...
    commands: [
      ...
      },
      {
        ...
        timeoutMs: 150_000,
        requiredMarkers: ["PASS bounded Rider 2025.3 sandbox startup: dev.gaep.productstudio@0.1.0 loaded from exact isolated paths"],
      },
    ],
  },
  "visual-studio": {
    ...
    commands: [{
      ...
      requiredMarkers: [
        ...
        "GAEP Visual Studio host-client tests: PASS (229)",
      ],
    }],
  },
}
