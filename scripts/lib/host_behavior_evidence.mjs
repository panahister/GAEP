...
const definitions = {
  ...
  "visual-studio": {
    ...
    gatePaths: [
      ...
      "apps/visual-studio/Gaep.HostClient/ImplementationUnitModelModels.cs",
      ...
      "apps/visual-studio/Gaep.HostClient/BoilerplateSelectionBindingModels.cs",
      ...
      "apps/visual-studio/Gaep.HostClient/DesignToCodeBindingRegistryModels.cs",
      ...
      "apps/visual-studio/Gaep.HostClient/UserJourneyModels.cs",
      "apps/visual-studio/Gaep.HostClient/UserJourneyProtocol.cs",
      "apps/visual-studio/Gaep.HostClient/InformationArchitectureModels.cs",
      "apps/visual-studio/Gaep.HostClient/InformationArchitectureProtocol.cs",
      "apps/visual-studio/Gaep.HostClient/ScreenStateInventoryModels.cs",
      ...
      "apps/visual-studio/Gaep.HostClient/BacklogHierarchyModels.cs",
      "apps/visual-studio/Gaep.HostClient/BacklogHierarchyProtocol.cs",
      "apps/visual-studio/Gaep.HostClient/MvpSliceDefinitionModels.cs",
      "apps/visual-studio/Gaep.HostClient/MvpSliceDefinitionProtocol.cs",
      ...
      "apps/visual-studio/Gaep.HostClient/FigmaMcpCapabilityDiscoveryModels.cs",
      "apps/visual-studio/Gaep.HostClient/FigmaMcpCapabilityDiscoveryProtocol.cs",
      "apps/visual-studio/Gaep.HostClient/FigmaReadSnapshotModels.cs",
      ...
      "apps/visual-studio/Gaep.HostClient/FinalizedFigmaSnapshotImportModels.cs",
      "apps/visual-studio/Gaep.HostClient/FinalizedFigmaSnapshotImportProtocol.cs",
      ...
      "apps/visual-studio/Gaep.HostClient/DesignBaselineModels.cs",
      "apps/visual-studio/Gaep.HostClient/DesignBaselineProtocol.cs",
      "apps/visual-studio/Gaep.HostClient/DesignDriftDetectionModels.cs",
    ...
    commands: [{
      ...
      requiredMarkers: [
        ...
        "GAEP Visual Studio host-client tests: PASS (769)",
      ],
    }],
  },
}
