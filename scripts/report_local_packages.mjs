...
const definitions = [
  ...
  },
  {
    ...
    requiredHere: true,
    verification: "exact-isolated-compatible-host-fixture-upgrade-reinstall-rollback-uninstall-absence-final-install-activation-digest-bound-package-local-provider-model-phase-1-phase-2-and-phase-3a-backlog-hierarchy-plus-mvp-slice-definition-plus-prioritization-model-plus-acceptance-criteria-plus-definition-of-ready-plus-definition-of-done-plus-implementation-unit-model-plus-dependency-mapping-plus-technology-profile-plus-boilerplate-registry-plus-boilerplate-selection-binding-plus-boilerplate-compatibility-validation-workflows-with-private-safe-output-and-immutable-store",
  },
  {
    host: "rider",
  ...
  },
  {
    ...
    verification: "cross-platform-shell-contribution-remote-ui-binding-exact-hostclient-embedded-engine-resource-and-714-protocol-controller-checks-with-phase-3a-backlog-hierarchy-plus-mvp-slice-definition-plus-prioritization-model-plus-acceptance-criteria-plus-definition-of-ready-plus-definition-of-done-plus-implementation-unit-model-plus-dependency-mapping-plus-technology-profile-plus-boilerplate-registry-plus-boilerplate-selection-binding-plus-boilerplate-compatibility-validation-and-packaged-engine-empty-evidence-workflow-windows-container-install-pending",
  },
]
