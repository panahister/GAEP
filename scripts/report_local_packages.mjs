...
const definitions = [
  ...
  },
  {
    ...
    verification: "cross-platform-shell-contribution-remote-ui-binding-exact-hostclient-embedded-engine-resource-and-746-protocol-controller-checks-with-phase-3a-backlog-hierarchy-plus-mvp-slice-definition-plus-prioritization-model-plus-acceptance-criteria-plus-definition-of-ready-plus-definition-of-done-plus-implementation-unit-model-plus-dependency-mapping-plus-technology-profile-plus-boilerplate-registry-plus-boilerplate-selection-binding-plus-boilerplate-compatibility-validation-plus-figma-to-boilerplate-mapping-plus-design-to-code-binding-registry-plus-route-screen-component-mapping-plus-test-methodology-and-packaged-engine-empty-evidence-workflow-windows-container-install-pending",
  },
]
