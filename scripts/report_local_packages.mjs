...
const definitions = [
  ...
  },
  {
    ...
    requiredHere: true,
    verification: "exact-isolated-compatible-host-fixture-upgrade-reinstall-rollback-uninstall-absence-final-install-and-activation",
  },
  {
    host: "rider",
  ...
  },
  {
    ...
    verification: "cross-platform-shell-contribution-remote-ui-binding-and-150-protocol-controller-checks-windows-container-install-pending",
  },
]
