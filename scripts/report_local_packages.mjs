...
const definitions = [
  {
    ...
    requiredHere: true,
    verification: "exact-isolated-fixture-upgrade-reinstall-rollback-uninstall-absence-final-install-activation-bundled-engine-empty-recovery-evidence-workflow-and-accessible-phase-3a-backlog-hierarchy-plus-mvp-slice-definition-plus-prioritization-model-plus-acceptance-criteria-product-studio-projection",
  },
  {
    host: "kiro",
  ...
  },
  {
    ...
    verification: "cross-platform-shell-contribution-remote-ui-binding-exact-hostclient-embedded-engine-resource-and-628-protocol-controller-checks-with-phase-3a-backlog-hierarchy-plus-mvp-slice-definition-plus-prioritization-model-plus-acceptance-criteria-and-packaged-engine-empty-evidence-workflow-windows-container-install-pending",
  },
]
