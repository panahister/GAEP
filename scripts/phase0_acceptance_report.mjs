...
const defaultPaths = {
  ...
  packages: "evidence/local-packages/20260730T200113Z-phase-3a-design-to-code-binding-registry-packages.json",
  conformance: "evidence/ide-conformance/20260730T200113Z-phase-3a-design-to-code-binding-registry.json",
...
export async function buildPhase0AcceptanceReport({
  ...
  const report = {
    ...
    claimBoundary: designToCodeBindingRegistry
