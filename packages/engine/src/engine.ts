...
import { DefinitionOfReadyService } from "./definition-of-ready.js"
...
import { InformationArchitectureModelService } from "./information-architecture-model.js"
import { ScreenStateInventoryService } from "./screen-state-inventory.js"
...
import { FigmaContextImportService } from "./figma-context-import.js"
import { OutboundDesignBriefPackageService } from "./outbound-design-brief-package.js"
...
import { DesignBaselineService } from "./design-baseline.js"
import { DesignDriftDetectionService } from "./design-drift-detection.js"
...
export class GaepEngine {
  ...
  readonly definitionOfReady: DefinitionOfReadyService
  ...
  readonly designToCodeBindingRegistry: DesignToCodeBindingRegistryService
  readonly routeScreenComponentMapping: RouteScreenComponentMappingService
  readonly testMethodology: TestMethodologyService
  ...
  readonly changedUnitInventory: ChangedUnitInventoryService
  readonly proposedChangePreview: ProposedChangePreviewService
  readonly stagingWorkspace: StagingWorkspaceService
  ...
  readonly informationArchitectureModel: InformationArchitectureModelService
  readonly screenStateInventory: ScreenStateInventoryService
  ...
  readonly figmaContextImport: FigmaContextImportService
  readonly outboundDesignBriefPackage: OutboundDesignBriefPackageService
  ...
  readonly designBaseline: DesignBaselineService
  readonly designDriftDetection: DesignDriftDetectionService
  ...
  constructor(
    ...
    this.backlogHierarchy = new BacklogHierarchyService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.productStudio,
    )
    this.mvpSliceDefinition = new MvpSliceDefinitionService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
    ...
    this.definitionOfReady = new DefinitionOfReadyService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.backlogHierarchy,
    ...
    this.definitionOfDone = new DefinitionOfDoneService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.backlogHierarchy,
    ...
    this.implementationUnitModel = new ImplementationUnitModelService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.backlogHierarchy,
    ...
    this.dependencyMapping = new DependencyMappingService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.backlogHierarchy,
    ...
    this.boilerplateSelectionBinding = new BoilerplateSelectionBindingService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.implementationUnitModel,
    ...
    this.boilerplateCompatibilityValidation = new BoilerplateCompatibilityValidationService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.implementationUnitModel,
    ...
    this.informationArchitectureModel = new InformationArchitectureModelService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.sourceGovernance,
      this.designApplicability,
      this.designPersonaRoleModel,
      this.userJourneyModel,
    )
    this.screenStateInventory = new ScreenStateInventoryService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.sourceGovernance,
      this.informationArchitectureModel,
    )
    this.designRequirements = new DesignRequirementsService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.sourceGovernance,
    ...
    this.designSystemTokenContract = new DesignSystemTokenContractService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.sourceGovernance,
    ...
    this.accessibilityDesignRules = new AccessibilityDesignRulesService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.sourceGovernance,
    ...
    this.figmaMcpCapabilityDiscovery = new FigmaMcpCapabilityDiscoveryService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.sourceGovernance,
    ...
    this.figmaContextImport = new FigmaContextImportService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      (id) => this.productStudio.readContextPack(id),
      this.sourceGovernance,
      this.designApplicability,
      this.designRequirements,
      this.designSystemTokenContract,
      ...
      this.manualFigmaExecutionPath,
      this.figmaMcpCapabilityDiscovery,
      this.figmaReadSnapshot,
    )
    this.outboundDesignBriefPackage = new OutboundDesignBriefPackageService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      (id) => this.productStudio.readContextPack(id),
      this.sourceGovernance,
      this.figmaContextImport,
    )
    this.governedFigmaWrite = new GovernedFigmaWriteService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.sourceGovernance,
      this.outboundDesignBriefPackage,
    )
    this.finalizedFigmaSnapshotImport = new FinalizedFigmaSnapshotImportService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.sourceGovernance,
      this.governedFigmaWrite,
    )
    this.designToRequirementBinding = new DesignToRequirementBindingService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.sourceGovernance,
    ...
    this.designDelta = new DesignDeltaService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.sourceGovernance,
      {
        designerReadyGate: this.designerReadyGate,
        finalizedSnapshot: this.finalizedFigmaSnapshotImport,
        designBinding: this.designToRequirementBinding,
      },
    )
    this.designConflictResolution = new DesignConflictResolutionService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.sourceGovernance,
    ...
    this.designBaseline = new DesignBaselineService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.sourceGovernance,
    ...
    this.designToCodeBindingRegistry = new DesignToCodeBindingRegistryService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.designBaseline,
      this.finalizedFigmaSnapshotImport,
      this.designToRequirementBinding,
      this.figmaToBoilerplateMapping,
      this.implementationUnitModel,
      this.technologyProfile,
      this.boilerplateSelectionBinding,
      this.boilerplateCompatibilityValidation,
    )
    this.routeScreenComponentMapping = new RouteScreenComponentMappingService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.informationArchitectureModel,
    ...
    this.testMethodology = new TestMethodologyService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.acceptanceCriteria,
    ...
    this.testInventory = new TestInventoryService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.acceptanceCriteria,
    ...
    this.highLevelDesign = new HighLevelDesignService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.systemSolutionArchitecture,
    ...
    this.lowLevelDesign = new LowLevelDesignService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
    ...
    this.changedUnitInventory = new ChangedUnitInventoryService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.backlogHierarchy,
      ...
      this.testInventory,
      this.riskRegister,
      this.implementationReadinessGate,
    )
    this.proposedChangePreview = new ProposedChangePreviewService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.changedUnitInventory,
    )
    this.stagingWorkspace = new StagingWorkspaceService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.proposedChangePreview,
    )
    this.controlledCodexImplementation = new ControlledCodexImplementationService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.proposedChangePreview,
      this.stagingWorkspace,
      () => this.readSelectionState(),
    )
    this.controlledClaudeImplementation = new ControlledClaudeImplementationService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      this.proposedChangePreview,
    ...
    this.providerSwitchImplementation = new ProviderSwitchImplementationService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
    ...
    this.controlledDesignToCodeGeneration = new ControlledDesignToCodeGenerationService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      {
        approvedFigmaContextRetrieval: this.approvedFigmaContextRetrieval,
        designBaseline: this.designBaseline,
        designToRequirementBinding: this.designToRequirementBinding,
        ...
        proposedChangePreview: this.proposedChangePreview,
        stagingWorkspace: this.stagingWorkspace,
        controlledCodexImplementation: this.controlledCodexImplementation,
        controlledClaudeImplementation: this.controlledClaudeImplementation,
        providerSwitchImplementation: this.providerSwitchImplementation,
        modelSwitchImplementation: this.modelSwitchImplementation,
      },
    )
    this.designToCodeTraceability = new DesignToCodeTraceabilityService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      {
    ...
    this.applyDiscardFoundation = new ApplyDiscardFoundationService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      {
        ...
        controlledCodexImplementation: this.controlledCodexImplementation,
        controlledClaudeImplementation: this.controlledClaudeImplementation,
        backlogToCodeTraceability: this.backlogToCodeTraceability,
      },
    )
    this.scopedApply = new ScopedApplyService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      {
    ...
    this.changeConflictDetection = new ChangeConflictDetectionService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      {
        ...
        applyDiscardFoundation: this.applyDiscardFoundation,
        scopedApply: this.scopedApply,
        rollbackRecovery: this.rollbackRecovery,
      },
    )
    this.testGeneration = new TestGenerationService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      {
        acceptanceCriteria: this.acceptanceCriteria,
        testMethodology: this.testMethodology,
        testInventory: this.testInventory,
        implementationUnitModel: this.implementationUnitModel,
        designToCodeTraceability: this.designToCodeTraceability,
        backlogToCodeTraceability: this.backlogToCodeTraceability,
        ...
        proposedChangePreview: this.proposedChangePreview,
        stagingWorkspace: this.stagingWorkspace,
        changeConflictDetection: this.changeConflictDetection,
      },
    )
    this.unitIntegrationTesting = new UnitIntegrationTestingService(
      this.repository,
      () => this.readProduct(),
      (id) => this.readInitiative(id),
      {
        testGeneration: this.testGeneration,
        testMethodology: this.testMethodology,
        testInventory: this.testInventory,
        acceptanceCriteria: this.acceptanceCriteria,
        implementationUnitModel: this.implementationUnitModel,
    ...
    this.designDriftDetection = new DesignDriftDetectionService(
      ...
      {
        designBaseline: this.designBaseline,
        returnedFigmaSnapshot: this.finalizedFigmaSnapshotImport,
        designRequirements: this.designRequirements,
        designTrace: this.designToRequirementBinding,
      },
    )
  ...
  async workspaceHealth() {
    ...
    try {
      const [acceptanceCriteriaIssues, definitionOfReadyIssues, definitionOfDoneIssues, implementationUnitModelIssues, dependencyMappingIssues, technologyProfileIssues, boilerplateRegistryIssues, boilerplateSelectionBindingIssues, boilerplateCompatibilityValidationIssues, routeScreenComponentMappingIssues, testMethodologyIssues, testInventoryIssues, highLevelDesignIssues, lowLevelDesignIssues, implementationReadinessGateIssues, changedUnitInventoryIssues, proposedChangePreviewIssues, stagingWorkspaceIssues, controlledCodexImplementationIssues, controlledClaudeImplementationIssues, providerSwitchImplementationIssues, modelSwitchImplementationIssues, approvedFigmaContextRetrievalIssues, controlledDesignToCodeGenerationIssues, designToCodeTraceabilityIssues, boilerplateConstraintEnforcementIssues, backlogToCodeTraceabilityIssues, applyDiscardFoundationIssues, scopedApplyIssues, rollbackRecoveryIssues, changeConflictDetectionIssues, testGenerationIssues, unitIntegrationTestingIssues] = await Promise.all([
        ...
        this.routeScreenComponentMapping.healthIssues(),
        this.testMethodology.healthIssues(),
        ...
        this.changedUnitInventory.healthIssues(),
        this.proposedChangePreview.healthIssues(),
        this.stagingWorkspace.healthIssues(),
        ...
        this.changeConflictDetection.healthIssues(),
        this.testGeneration.healthIssues(),
        this.unitIntegrationTesting.healthIssues(),
      ])
      const [productIssues, backlogHierarchyIssues, mvpSliceDefinitionIssues, prioritizationModelIssues, sourceIssues, businessIssues, capabilityMapIssues, valueStreamIssues, operatingModelIssues, businessRuleIssues, businessArchitectureIssues, systemSolutionArchitectureIssues, boundedContextModelIssues, securityPrivacyAssessmentIssues, processModelIssues, dataModelIssues, authorizationModelIssues, eventIntegrationModelIssues, failureRecoveryModelIssues, architectureChallengeModelIssues, decisionRegisterIssues, riskRegisterIssues, evidenceRegistryIssues, traceabilityIssues, p0P4ReadinessGateIssues, p5HandoffPackageIssues, designApplicabilityIssues, designPersonaRoleIssues, userJourneyIssues, informationArchitectureIssues, screenStateInventoryIssues, designRequirementsIssues, designSystemTokenContractIssues, accessibilityDesignRulesIssues, responsiveMultiPlatformTargetsIssues, manualFigmaExecutionPathIssues, figmaMcpCapabilityDiscoveryIssues, figmaReadSnapshotIssues, figmaContextImportIssues, outboundDesignBriefPackageIssues, governedFigmaWriteIssues, finalizedFigmaSnapshotImportIssues, designToRequirementBindingIssues, designerReadyGateIssues, designDeltaIssues, designConflictResolutionIssues, humanDesignApprovalIssues, designBaselineIssues, designDriftDetectionIssues, figmaToBoilerplateMappingIssues, designToCodeBindingRegistryIssues] = await Promise.all([
        ...
        this.informationArchitectureModel.healthIssues(),
        this.screenStateInventory.healthIssues(),
        ...
        this.figmaContextImport.healthIssues(),
        this.outboundDesignBriefPackage.healthIssues(),
        ...
        this.designToCodeBindingRegistry.healthIssues(),
      ])
      domainIssues = [
        ...productIssues,
        ...
        ...designToCodeBindingRegistryIssues,
        ...routeScreenComponentMappingIssues,
        ...testMethodologyIssues,
        ...testInventoryIssues,
        ...highLevelDesignIssues,
        ...lowLevelDesignIssues,
        ...implementationReadinessGateIssues,
        ...changedUnitInventoryIssues,
        ...proposedChangePreviewIssues,
        ...stagingWorkspaceIssues,
        ...controlledCodexImplementationIssues,
        ...
        ...changeConflictDetectionIssues,
        ...testGenerationIssues,
        ...unitIntegrationTestingIssues,
        ...sourceIssues,
        ...businessIssues,
        ...capabilityMapIssues,
        ...valueStreamIssues,
        ...
        ...userJourneyIssues,
        ...informationArchitectureIssues,
        ...screenStateInventoryIssues,
        ...
        ...figmaContextImportIssues,
        ...outboundDesignBriefPackageIssues,
        ...
        ...designBaselineIssues,
        ...designDriftDetectionIssues,
      ]
    } catch (error) {
      domainIssues = [{
