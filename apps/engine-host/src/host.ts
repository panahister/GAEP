...
const v2OnlyMethods = new Set<EngineHostMethod>([
  ...
  "planning.highLevelDesign.read",
  "planning.highLevelDesign.create",
  ...
  "delivery.controlledDesignToCodeGeneration.snapshot",
  "source.list",
  "source.create",
  "source.revise",
...
export class EngineHost {
  ...
  private async dispatchInternal(rawRequest: unknown): Promise<unknown> {
    ...
    switch (request.method) {
      ...
      case "planning.highLevelDesign.read":
        return await this.engine.highLevelDesign.readCurrent(request.params.initiativeId) ?? null
      case "planning.highLevelDesign.create":
        return this.engine.highLevelDesign.create(request.params.record, actorId(request.params.actorId))
      case "planning.highLevelDesign.revise":
        return this.engine.highLevelDesign.revise(
          request.params.recordId,
          request.params.expectedRevision,
          request.params.record,
          actorId(request.params.actorId),
        )
      case "planning.highLevelDesign.assess":
      ...
      case "delivery.controlledClaudeImplementation.snapshot":
        return this.engine.controlledClaudeImplementation.project(request.params.initiativeId)
      case "delivery.providerSwitchImplementation.snapshot":
      ...
      case "delivery.controlledDesignToCodeGeneration.snapshot":
        return this.engine.controlledDesignToCodeGeneration.project(request.params.initiativeId)
      case "source.list":
