...
R = Responsible · A = Accountable · C = Consulted · I = Informed. Exactly one A is required for each governed decision; this overview may show several A roles because a checkpoint contains several substeps.
