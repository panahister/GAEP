...
internal sealed class GaepToolWindowData : NotifyPropertyChangedObject
{
    ...
    public GaepToolWindowData(VisualStudioExtensibility extensibility)
    {
        ...
        LoadDesignDriftDetectionCommand = new AsyncCommand(LoadDesignDriftDetectionAsync);
        ...
        ShowPhase3aDashboardCommand = new AsyncCommand(ShowPhase3aDashboardAsync);
    ...
    [DataMember]
    public IAsyncCommand LoadDesignToCodeBindingRegistryCommand { get; }
    ...
    [DataMember]
    public IAsyncCommand LoadTestInventoryCommand { get; }
    ...
    public IAsyncCommand LoadChangedUnitInventoryCommand { get; }
    ...
    [DataMember]
    public IAsyncCommand LoadDesignDriftDetectionCommand { get; }
    ...
    [DataMember]
    public IAsyncCommand ShowPhase3aDashboardCommand { get; }
    ...
    private Task LoadMvpSliceDefinitionAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
            "Loading exact governed MVP and Vertical Slice candidate",
            (controller, _, token) => controller.ReadMvpSliceDefinitionAsync(ParseInitiativeId(InitiativeId), token),
            cancellationToken);

    private Task LoadPrioritizationModelAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task LoadDefinitionOfReadyAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task LoadImplementationUnitModelAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task LoadTechnologyProfileAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task LoadDesignToCodeBindingRegistryAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
            "Loading exact governed Design-to-Code Binding Registry candidate",
            (controller, _, token) => controller.ReadDesignToCodeBindingRegistryAsync(ParseInitiativeId(InitiativeId), token),
            cancellationToken);

    private Task LoadRouteScreenComponentMappingAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task LoadTestInventoryAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
            "Loading exact governed Test Inventory candidate",
            (controller, _, token) => controller.ReadTestInventoryAsync(ParseInitiativeId(InitiativeId), token),
            cancellationToken);

    private Task LoadHighLevelDesignAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task LoadChangedUnitInventoryAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
            "Loading exact governed Changed Unit Inventory candidate",
            (controller, _, token) => controller.ReadChangedUnitInventoryAsync(ParseInitiativeId(InitiativeId), token),
            cancellationToken);

    private Task LoadProposedChangePreviewAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task LoadApprovedFigmaContextRetrievalAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task LoadAccessibilityDesignRulesAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task LoadFigmaMcpCapabilityDiscoveryAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task LoadOutboundDesignBriefPackageAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task LoadFinalizedFigmaSnapshotImportAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task LoadHumanDesignApprovalAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task LoadDesignDriftDetectionAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
            "Loading exact Design Drift Detection candidate",
            (controller, _, token) => controller.ReadDesignDriftDetectionAsync(ParseInitiativeId(InitiativeId), token),
            cancellationToken);
    ...
    private Task ShowPhase2UxFigmaDashboardAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
    ...
    private Task ShowPhase3aDashboardAsync(object? commandParameter, CancellationToken cancellationToken) =>
        RunRequestAsync(
            "Loading exact Phase 3A backlog and implementation readiness dashboard",
            (controller, _, token) => controller.ReadPhase3aDashboardAsync(ParseInitiativeId(InitiativeId), token),
            cancellationToken);
