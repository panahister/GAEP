...
public sealed record LowLevelDesignRecordView(
...
public sealed record LowLevelDesignProjection(
    Guid ProductId, long ProductRevision, string ProductDigest, Guid InitiativeId, long InitiativeRevision,
    string InitiativeDigest, string InitiativeState, Guid ImplementationUnitId, string State, string ReviewState, IReadOnlyList<string> Reasons,
    ...
    int UnresolvedQuestionCount, LowLevelDesignRecordView? Candidate, string SnapshotDigest);
